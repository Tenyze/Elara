...
public class ClickGui extends GuiScreen {
    ...
    public ClickGui() {
        ...
        combatModules.add(Elara.moduleManager.getModule(Velocity.class));
        combatModules.add(Elara.moduleManager.getModule(KeepSprint.class));
        ...
        movementModules.add(Elara.moduleManager.getModule(InventoryMove.class));
