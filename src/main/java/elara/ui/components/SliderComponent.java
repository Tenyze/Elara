...
import elara.ui.callback.GuiInput;
import elara.ui.dataset.Slider;
...
public class SliderComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        Gui.drawRect(sliderStart, this.parentModule.category.getY() + this.offsetY + 11, sliderEnd, this.parentModule.category.getY() + this.offsetY + 15, ((HUD) Elara.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()).getRGB());
        GL11.glPushMatrix();
    ...
    public void mouseDown(int x, int y, int button) {
        ...
        if (this.isRightHalfHovered(x, y)) {
            if (button == 0) {
                this.dragging = true;
