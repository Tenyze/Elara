...
import elara.module.combat.KeepSprint;
...
public class ElaraModulesPage extends Page {
   ...
   static {
      ...
      MODULE_CATEGORIES.put(Velocity.class, "Combat");
      MODULE_CATEGORIES.put(KeepSprint.class, "Combat");
      ...
      MODULE_CATEGORIES.put(InventoryMove.class, "Movement");
