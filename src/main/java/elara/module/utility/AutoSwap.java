...
public class AutoSwap extends Module {
    ...
    public AutoSwap() {
        ...
        blocks.setCategory("General");
        projectiles.setCategory("General");
        pearls.setCategory("General");
        swords.setCategory("General");
        tools.setCategory("General");
        resources.setCategory("General");
    }
