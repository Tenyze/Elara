...
public class Eagle extends Module {
    ...
    public Eagle() {
        super("Eagle", false);
        // 折叠分组
        minDelay.setCategory("Timing");
        maxDelay.setCategory("Timing");
        directionCheck.setCategory("Conditions");
        jumpCheck.setCategory("Conditions");
        pitchCheck.setCategory("Conditions");
        blocksOnly.setCategory("Conditions");
        sneakOnly.setCategory("Conditions");
    }
