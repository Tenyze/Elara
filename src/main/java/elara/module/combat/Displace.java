...
public class Displace extends Module {
    ...
    public Displace() {
        ...
        yawOffset.setCategory("Rotation");
        delay.setCategory("Timing");
        direction.setCategory("Movement");
        findVoid.setCategory("Conditions");
        blink.setCategory("Other");
        hasKnockback.setCategory("Conditions");
    }
    ...
    private void releaseBlink() {
        Elara.blinkManager.setBlinkState(false, BlinkModules.DISPLACE);
    }
    ...
    public void onSendPacket(PacketEvent event) {
        ...
        if (Elara.blinkManager.getBlinkingModule() == BlinkModules.DISPLACE) {
            return;
        }

        Elara.blinkManager.setBlinkState(true, BlinkModules.DISPLACE);
