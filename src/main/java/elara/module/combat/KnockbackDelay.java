...
public class KnockbackDelay extends Module {
    ...
    public KnockbackDelay() {
        ...
        airDelay.setCategory("Timing");
        groundDelay.setCategory("Timing");
        chance.setCategory("Other");
        realtimeDamage.setCategory("Display");
        requireTarget.setCategory("Conditions");
        onlySwords.setCategory("Conditions");
    }
    ...
    private Entity findTarget() {
        KillAura ka = (elara.module.combat.KillAura) Elara.moduleManager.modules.get(elara.module.combat.KillAura.class);
