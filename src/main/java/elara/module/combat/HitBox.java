...
public class HitBox extends Module {
    ...
    public HitBox() {
        ...
        multiplier.setCategory("Combat");
        showHitbox.setCategory("Display");
        color.setCategory("Appearance");
        teams.setCategory("Targeting");
        botCheck.setCategory("Targeting");
    }

    public static float getExpansion(Entity entity) {
        HitBox hitBox = (HitBox) Elara.moduleManager.modules.get(HitBox.class);
