...
public class SprintReset extends Module {
    ...
    public SprintReset() {
        ...
        onlyWhileSprinting.setCategory("Conditions");
        onlyWhileMoving.setCategory("Conditions");
        resetOnCrit.setCategory("Combat");
        smartReset.setCategory("Conditions");
        fastReset.setCategory("Movement");
    }
