...
public class BedESP extends Module {
    ...
    private Color getColor() {
        switch (this.color.getValue()) {
            ...
            case 1:
                return ((elara.module.render.HUD) Elara.moduleManager.modules.get(elara.module.render.HUD.class)).getColor(System.currentTimeMillis());
            default:
                return new Color(-1);
        }
    }
    ...
    public BedESP() {
        ...
        mode.setCategory("Display");
        color.setCategory("Appearance");
        customColor.setCategory("Appearance");
        opacity.setCategory("Appearance");
        outline.setCategory("Appearance");
        obsidian.setCategory("Display");
    }
