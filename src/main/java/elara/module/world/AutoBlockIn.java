...
public class AutoBlockIn extends Module {
    ...
    public AutoBlockIn() {
        super("AutoBlockIn", false, false, "Automatically place blocks to trap yourself", ModuleCategory.WORLD);
        ...
        speed.setCategory("Rotation");
        placeDelay.setCategory("Timing");
        rotationTolerance.setCategory("Rotation");
        itemSpoof.setCategory("Placement");
        showProgress.setCategory("Display");
