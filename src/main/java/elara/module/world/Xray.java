...
public class Xray extends Module {
    ...
    public Xray() {
        ...
        opacity.setCategory("Appearance");
        range.setCategory("Display");
        cavesOnly.setCategory("Conditions");
        caveRadius.setCategory("Display");
        diamonds.setCategory("Display");
        diamondTracers.setCategory("Display");
        gold.setCategory("Display");
        goldTracers.setCategory("Display");
        iron.setCategory("Display");
        ironTracers.setCategory("Display");
        coal.setCategory("Display");
        coalTracers.setCategory("Display");
        redstone.setCategory("Display");
        redStoneTracers.setCategory("Display");
        lapis.setCategory("Display");
        lapisTracers.setCategory("Display");
        emeralds.setCategory("Display");
        emeraldsTracers.setCategory("Display");
        spawners.setCategory("Display");
        spawnerTracers.setCategory("Display");
        canes.setCategory("Display");
        canesTracers.setCategory("Display");
        warts.setCategory("Display");
        wartsTracers.setCategory("Display");
    }
