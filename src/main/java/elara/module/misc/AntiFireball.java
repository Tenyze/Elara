...
public class AntiFireball extends Module {
    ...
    public AntiFireball() {
        ...
        rotations.setCategory("Rotation");
        swing.setCategory("Combat");
        moveFix.setCategory("Movement");
    ...
    public void onUpdate(UpdateEvent event) {
        if (this.isEnabled() && event.getType() == EventType.PRE) {
            ...
            if (TeamUtil.isEntityLoaded(fireball)) {
                ...
                if (!Elara.playerStateManager.attacking && !Elara.playerStateManager.digging && !Elara.playerStateManager.placing) {
            ...
            if (this.showTarget.getValue() != 0 && TeamUtil.isEntityLoaded(this.target)) {
                ...
                switch (this.showTarget.getValue()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        color = ((elara.module.render.HUD) Elara.moduleManager.modules.get(elara.module.render.HUD.class)).getColor(System.currentTimeMillis());
                }
