...
public class AntiBot extends Module {
    ...
    public AntiBot() {
        ...
        basic.setCategory("Other");
        matrixBot.setCategory("Other");
        tab.setCategory("Conditions");
        tabMode.setCategory("Conditions");
        entityID.setCategory("Targeting");
        color.setCategory("Appearance");
        livingTime.setCategory("Conditions");
        livingTimeTicks.setCategory("Timing");
        ground.setCategory("Conditions");
        air.setCategory("Conditions");
        invalidGround.setCategory("Conditions");
        swing.setCategory("Conditions");
        health.setCategory("Conditions");
        minHealth.setCategory("Targeting");
        maxHealth.setCategory("Targeting");
        derp.setCategory("Conditions");
        wasInvisible.setCategory("Conditions");
        armor.setCategory("Conditions");
        ping.setCategory("Conditions");
        needHit.setCategory("Conditions");
        spawnInCombat.setCategory("Conditions");
        duplicateInWorld.setCategory("Conditions");
        duplicateInTab.setCategory("Conditions");
        duplicateCompareMode.setCategory("Conditions");
        experimentalNPCDetection.setCategory("Conditions");
        illegalName.setCategory("Conditions");
        removeFromWorld.setCategory("Other");
        removeInterval.setCategory("Timing");
    ...
    public void onTick(TickEvent event) {
        ...
        for (EntityPlayer bot : bots) {
            ...
            if (debug.getValue()) {
                ChatUtil.sendFormatted(String.format("%sAntiBot: &fRemoved &r%s &fdue to it being a bot.", Elara.clientName, bot.getName()));
            }
        }
    }
    ...
    private void handleMatrixBot() {
        ...
        if (matrixCollectSample) {
            ...
            for (EntityPlayer bot : bots) {
                ...
                if (debug.getValue()) {
                    ChatUtil.sendFormatted(String.format("%sAntiBot/MatrixBot: &fRemoved &r%s&f. Speed: &b%.2f&f.", Elara.clientName, bot.getName(), getHorizontalSpeed(bot)));
                }
            }
        }
    ...
    public static boolean isBot(EntityLivingBase entity) {
        AntiBot antiBot = (elara.module.misc.AntiBot) Elara.moduleManager.getModule(elara.module.misc.AntiBot.class);
