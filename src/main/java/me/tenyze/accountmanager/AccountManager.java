package me.tenyze.accountmanager;
...
public class AccountManager {
    ...
    private static final File file = new File(mc.mcDataDir, "elara.accounts.json");
            ...
            try {
                if (file.getParentFile().exists() || file.getParentFile().mkdirs()) {
                    if (file.createNewFile()) {
                        System.out.print("Successfully created elara.accounts.json!");
                    }
                }
            } catch (IOException e) {
                System.err.print("Couldn't create elara.accounts.json!");
            }
        }
    }
    ...
    public static void load() {
        ...
        try {
            ...
            System.err.print("Couldn't find elara.accounts.json!");
        }
    }
    ...
    public static void save() {
        try {
            ...
            System.err.print("Couldn't save elara.accounts.json!");
        }
    }
}
